    ...
    if (selectHeader) {
        const headerScrolled = () => {
            if (window.scrollY > 170) {
                ...
                document.getElementById('logo-title-image').classList.remove('show');
            }
            else {
                document.getElementById('logo-header').classList.add('hide');
                document.getElementById('logo-title-image').classList.add('show');
                document.getElementById('logo-header').classList.remove('show');
                document.getElementById('logo-title-image').classList.remove('hide');
            }
        }
